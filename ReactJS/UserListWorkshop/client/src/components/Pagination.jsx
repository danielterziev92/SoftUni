...
export const Pagination = ({
                               ...
                               currentPage,
                               pageCount,
                               clickFirstPageHandler,
                               clickLastPageHandler,
                               clickNextPageHandler,
                               clickPreviousPageHandler,
                           }) => {
    const [itemsPerPage, setItemsPerPage] = useState(['5', '10'])

    const changeOptionNumberHandler = (e) => {
        setUsersPerPage(Number(e.currentTarget.value));
    }
    ...
    return (
        <div className="pagination position">
            <div className="limits">
                ...
                <select name="limit" className="limit" value={usersPerPage} onChange={changeOptionNumberHandler}>
                    {itemsPerPage.map(numb => (
            ...
            <p className="pages">{currentPage} - 1 of {pageCount}</p>
            <div className="actions">
                <button className="btn" title="First Page" onClick={clickFirstPageHandler}>
                ...
                <button className="btn" title="Previous Page" onClick={clickPreviousPageHandler}>
                ...
                <button className="btn" title="Next Page" onClick={clickNextPageHandler}>
                ...
                <button className="btn" title="Last Page" onClick={clickLastPageHandler}>
