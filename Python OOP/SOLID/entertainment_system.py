...
class Television(RCAConnector, HMDIConnector, PowerOutlet):
...
class DVDPlayer(HMDIConnector, PowerOutlet):
...
class GameConsole(HMDIConnector, EthernetConnector, PowerOutlet):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
